...
save_teacher_path = '../datasets/BGL/model/random_teacher_lstm.pth'
save_student_path = '../datasets/BGL/model/random_student_lstm.pth'
save_noKD_path = '../datasets/BGL/model/random_noKD_lstm.pth'
