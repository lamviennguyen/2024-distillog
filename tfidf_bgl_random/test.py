...
save_teacher_path = '../datasets/BGL/model/tfidf_random_teacher.pth'
save_student_path = '../datasets/BGL/model/tfidf_random_student.pth'
save_noKD_path = '../datasets/BGL/model/tfidf_random_noKD.pth'
