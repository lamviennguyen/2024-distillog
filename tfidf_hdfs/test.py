...
save_teacher_path = '../datasets/HDFS/model/tfidf_teacher.pth'
save_student_path = '../datasets/HDFS/model/tfidf_student.pth'
save_noKD_path = '../datasets/HDFS/model/tfidf_noKD.pth'
test_path = '../datasets/HDFS/test.csv'
#save_quantized_path = '../datasets/HDFS/model/quantized_model.pth'

fi = pd.read_csv('../datasets/HDFS/tfidf_HDFS_vector.csv', header = None)
vec = []
vec = fi
vec = np.array(vec)
