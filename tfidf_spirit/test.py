...
save_teacher_path = '../datasets/Spirit/model/tfidf_chronological_teacher.pth'
save_student_path = '../datasets/Spirit/model/tfidf_chronological_student.pth'
save_noKD_path = '../datasets/Spirit/model/tfidf_chronological_noKD.pth'
test_path = '../datasets/Spirit/chronological_test.csv'
#save_quantized_path = '../datasets/Spirit/model/quantized_model.pth'

fi = pd.read_csv('../datasets/Spirit/tfidf_spirit_chronological_vector.csv', header = None)
vec = []
vec = fi
vec = np.array(vec)
